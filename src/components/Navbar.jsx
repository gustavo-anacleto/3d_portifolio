      ...
      <div
        ...
        <div className='flex'>
          ...
          <div className='ml-4 flex items-center'>
            <a href="https://www.linkedin.com/in/gustavo-santimaria-anacleto-3a9a0a207/" target='_blank'>
              <img src={linkedin} alt="linkedin" className="w-9 h-9 rounded-full mr-4" />

            </a>
            <a href="https://github.com/gustavo-anacleto" target='_blank'>
